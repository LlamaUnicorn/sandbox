...
web_source = f'https://api.openweathermap.org/geo/1.0/direct?q={user_location}&limit=5&appid={TOKEN}'
...
weather_report = f"Feels like: {texts_weather['main']['feels_like']}°C"
